...
class helper_base extends helper_config {
  ...
  */
  ...
  public static function get_resources()
  {
    if (self::$resource_list===null) {
      ...
      if (substr($indicia_theme_path, -1)!=='/')
        $indicia_theme_path .= '/';
      self::$resource_list = array (h
      iindiciaFns' => array('deps' =>array('jquery'), 'javascript' => array(self::$js_path."indicia.functions.js")),h
      if (substr($indicia_theme_path, -1)!=='/')
        $indicia_theme_path .= '/';
      self::$resource_list = rray (
        'jquery' => array('javascript' => array(self::$js_pa(function_exists('iform_openlayers_get_file') ? iform_openlayers_get_file() : "OpenLayers.js"),
           elf::$js_path."ie_vml_sizzlepatch_2.js")),
        'openla, self::$js_path."lang/enenlayer' => array('javascript' => array(self::$js_path."OpenLayers.js", self::$js_path."proj4js.js", self::$js_path."proj4defs.j
        'clearLayeript' => array(self::$js_path."OpenLayers.js", self::$js_path."proj4js.js", selfclearLayer.js")),le.js")),
        ...
        'locationFinder => array(createPersonalSites'deps' => array(''), 'stylesheets' => array(self::$css_path."default_site.c"createPersonalSitesnFinder => array('deps' =>array('indiciaMapEdit'), 'javascript' => array(self::$js_path."jquery.indiciaMap.edit.locationFinder.js")),
        'autocomplete' => array('deps' => array('jquery'), 'styesheets' =indicia_locks' => array('deps' =>array('jquery_cookie', 'json'), 'javascript' => array(self::$js_path."indicia.locks), 'sty
        'jquery_cookie' => array('deps' =>array('jquery'), 'javascript' => array(self::$js_path."jquery.cookie.js")),esheets' => array(self::$css_path."jquery.autocomplete.css"), 'javascript' => array(self::$js_path."jquery.autocomplete.js")),
       ...
       'jqueryquery_form'deps' => array(''), 'stylesheets' => array(self::$css_path."default_site.c"jquery.form),
   
        'json' => array('javascript' => array(self::$js_path."json2.js")),ray(self::reportPicker' => array('deps' => array('treeview'), 'javascript' => array(self::$js_path."reportPickert' => aray(self::$js_path."jquery.ui.datepicker-fr.js")),
        'json' => array('javascript' => array(self::$js_path."json2.js")),
        'treeview' => array('deps' => array('jqu)),
        'treeview_async' => array('deps' => array('treeview'), 'javascript' => array(self::$js_path."jquery.treeview.async.js",eview.css"), 'javascript' => array(self::$js
        'googlemaps' => array('javascript' => array("http://maps.google.com/maps/api/js?v=3&amp;sensor=false")),rray('java'multimap' => array('javascript' => array("http://developer.multimap.com/API/maps/1.2/".parent::$multimap_api_ey)),
   pi?key=".parent::$google_search_api_key,
       ...
       'treeBrowser' => array('deps' => array('jquery','jquery_ui'), 'javascript' => array(self::$js_path."jquery.treebrowser.js")),
        'defaulttylesheet' => array('deps' => array(''), 'stylesheets' => array(self::$css_path."default_site.css"), 'jmetadata.js', self::$js_path.'jquery.validate.js', self::$js_path.'additional-methodst' => a
        'plupload' => array('deps' => array('jquery_ui','fancybox'), 'javascript' => array(:$js_path.'jquery.validate.js')),
        'plupload' => array('deplupload/js/plupload.full.minfbox'),'javascript' => array(
        ...
        'jqplot_pie' => array('javascript' => array(self::$js_path.'jqplot/plugins/jqplot.pieRenderer.min.js')),r.min.js')),
        'jqplot_pie' => array('javascript' => array(self::$js_path.'jqplot/plugins/jqplot.pieRenderer.min.js')),
        'jqplt_category_axis_rcanvas_axis_label_rendere:$js_path.'jqplot/jquery.jqplot.min.js',
                '[IE]'.self::$canvasTextRenderer.min.js', self::$js_path.'jqplot/plugins/jqplot.canvasAxisLabel')),
        'jqplt_category_axis_renderer' => array('javascript' => array(self::$js_path.'jqplot/plugins/jqplot.categoryAxisRenderer
        'reportgrid=> array('jquery_ui'), 'javascript' => array(self::$js_path.'jquery.reportgrid.jquery.reportgrid.js', self::$js_path.'json2.js')), array('dereportfilters' => array('deps' => array('reportgrid'), 'stylesheets' => array(self::$css_path."report-filters.css"), 'javascript' => array(self::$js_path.'reportFiltersgrid' = array('deps' => array('jquery_ui'), 'javascript' => array(self::$js_path.'jquery.reportgrid.js', self::js_path.'json2.js')),
        ...
        'timeentry' => array('javascript'=>array(self::$js_path."jquery.timeentry.pack.jonwi,
        ...
        'complexAttrGrid' => array('javascript'=>array(self::$js_path."complexAttrGrid.jonwi
      );
    }
   ...
   * defined for input of report parameters or the default values for a csv import.ired for a parameters form, e.g. the form
   * defined for input of report<ul>
   ...
   * Used in conjunction with forceLookupParamAutocomplete, if true then autocomplete parameter control is put into selectModeo
   * </li>
...
/**
  ...
  */
   ...
   * @param array $resources List of resources to include in the header. The available options are describedhich validates better.
  ...
  */
  public static function dump_javascript($closure=false) {oogle.com/p/indicia/wiki/TutorialBuildingBasicPage#Build_a_data_entry_page
  */
  publi
    if (self::$default_styles) self::add_resource('defaultStylesheet');o the end of the list, so it has highest CSS priority
  ...
  public static function get_scripts($javascript, $late_javascript, $onload_javascript, $includeWrapper=false, $closure=false) {
    if (!empty($javascript) || !empty($late_javascript) || !empty($onload_javascript)) {esource);
      $includeWrapper ? "<script type='text/javascript'>/* <![CDATA[ */\n" : "";
...
";
  ...
  **
   ...
   */
  public static function setup_jquery_validation_js() {ble for adding JavaScript
   * to the page via drupal_add_js.
   */
  public static func
  ...
  /**
   * Internal method to build a control from its option
   * suffix template.
   *uts the
   * prefix template, a label (if in the options), a control, the control's errors and a
   * uffix template.
   *
   * @param string $template Name of the control template, from the global $ind
  ...
  public static function apply_template($template, $options) {
    ...
    if (!array_key_exists('validation_mode', $options)) {
      $options['validation_mode']=self::$val
    $error="";
 ...
 $attr) {
      if (!empty($options[$name])) {
        $options[$name]=' '.$attr.'="'.$optio
    $r = self::get_help_text($options, 'before');
    //Add prefix
    $r .= self::apply_static_template('prefix', $options);

    // Add a label only if specified in the options array. Link the label to the inputId if available,'prefix', $options);

    // Add a label only if specified in the options array. Li
    if (!empty($options['label'])) {
      $r .= str_replace(
          array('{label}', '{id}', '{labelClass}'),
          array(
              $options['label'],   $r .= str_replace(
          array('{label}', '{id}', '{labelClass}'),
          array(
    ...
    // Output the main control['labelClass'].'"' : '',
          ),
...
s['fieldname']);
    ...
    // Add an error icon'fieldname', $options)) {
  ...
  * validation format. For example, 'validation' => array('required', 'email').et to an array of validation rules in Indicia
  * validation format. For examp
  */
  public static function enable_validation($form_id) {
    self::$validated_form_id = $form_id; is bself::$javascript .= "indiciaData.validatedFormId = '" . self::$validated_form_id . "';\n"o
 ...
 /**on enable_validation($form_id) {
  ...
  protected static function build_validation_class($options) {
    global $custom_terms; rules formatted as a class.
   */
  protected static function build_validation_class($opt
    if (!is_array($rules)) $rules = array($rules);ay_key_exists('validation', $options) ? $options['validation'] : array());
    if (
    ...
    foreach ($rules as $rule) {
      if (isset($custom_terms) && array_key_exists($options['fieldname'], $custom_terms))ed
    foreach ($rules as $rule) {
      if (isset($custom_terms) && array_key_exists($options['fieldnam
          lang::get($options['fieldname']));
    }
    // Convert these rules into jQuery format.:get("validation_$rule"),
          lang::get($options, $options['
  }
   ...
   * @param array $options Control's options array. Can specify the class for the help text 
  ...
  protected static function apply_replacements_to_template($template, $options) {
   ...
   /**ceValues, $options[$option]);
      }
    }
    return str_replace($replaceTags, $replaceValues, $templ
  * plugin metadata format.
  * @param array $rules List of validation rules to be converted.
  * @param array $options Options passed to the validated control. them to the jQuery validation
  * plugin metadata format.
  * @param arra
  ...
  protected static function convert_to_jquery_val_metadata($rules, $options) {
    ...
    foreach ($rules as $rule) {
      ...
      // Now any rules which need parsing or conversion
        ...
        $converted[] = 'number:true'; ($rule=='date') {
        $converted[] = 'customDate';
      } else if ($rule=='digit') {
        $c
      } elseif (preg_match('/maximum\[(?P<val>-?\d+)\]/', $rule, $matches)) {
        $converted[] = 'max:'.$matches['val'];
      // and again for minimum rules>\d+)\]/', $rule, $matches)) {
        $conver-?ted[] = '{maxValue:'.$matches
  ...
  */
   ...
   *ired for a parameters form, e.g. the form
   * defined for input of report
