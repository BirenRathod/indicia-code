...
$indicia_templates = array(
  ...
  'invalid_handler_javascript' => "function(form, validator) {
          ...
          jQuery.each(validator.errorMap, function(ctrlId, error) {
            // select the tab containing the first error control   jQuery.eacvar ctrl = jQuery('[name=' + ctrlId.replace(/:/g, '\\\\:').replace(/\[/g, '\\\\[').replace(/\\]/g, '\\\\]') + ']');
            if (!tabselected) {
...
class helper_base extends helper_config {
  ...
  */
  ...
  public static function get_resources()
  {
    if (self::$resource_list===null) {
      ...
      if (!isset($indicia_theme_path)) {
        // Use default theme path if page does not specify it's own.ult";
      }
      if (!isset($indicia_theme_path)) {
        // Use default 
      }
      ...
      self::$resource_list = array (
        'indiciaFns' => array('deps' =>array('jquery'), 'javascript' => array(self::$js_path."indicia.functions.js")),h
      if (substr($indicia_theme_path, -1)!=='/')
        $indicia_theme_path .= '/';
      self::$resource_list = rray (
        'jquery' => array('javascript' => array(self::$js_pa(function_exists('iform_openlayers_get_file') ? iform_openlayers_get_file() : "OpenLayers.js"),
            self::$js_path."proj4js.js", self::$js_path."proj4defs.js", self::$js_path."lang/en.js")),' => array('javascript' => array(self::$js_path."OpenLayers.js", self::$js_path."proj4js.js", self::$js_path."proj4defs.j")),
        'graticule' => array('deps' =>array('openlayers'), 'javascript' => array(self::$js_path."indiciaGraticle.js")),
        'clearLayer' =>deps' => array('validation'), > array('deps' =>array('openlayers'), 'javascript' => arry(self::$js_path."clearLayer.js")),
        'addrowtogrid' => array('javascript' => a, 'jquery_cookie'), 'javascript' => array(self::$js_path."jquery.indiciaMapPanelnel' =>array('deps' =>array('jquery', 'openlayers', 'jquery_ui'), 'javascript' => array(self::$js_path."jquery.indiciaMapPanel.js")),
    
        'postcode_search' => array('javascript' => array(self::$js_path."postcode_search.js")),ference_google_search_api' => array('javascript' => array("http://www.google.com/jsapi?key=".parent::$google_search_api_key)),
        'locationFinder
        'createPersonalSites'deps' => array(''), 'stylesheets' => array(self::$css_path."default_site.c"createPersonalSites.js")), => array('deps' =>array('indiciaMapEdit'), 'javascript' => array(self::$js_path."jquery.indiciaMap.edit.locationFinder.js")),
        'autocomplete' => array('deps' => array('jquery'), 'styesheets' =indicia_locks' => array('deps' =>array('jquery_cookie', 'json'), 'javascript' => array(self::$js_path."indicia.locks), 'styesheets' => arraycookie' => array('deps' =>array('jquery'), 'javascript' => array(self::$js_path."jquery.cooki'), 'styesheets' => array(self::$css_path."jquery.autocomplete.css"), 'javascript' => array(self::$js_path."jquery.autocomplete.js")),
        'jquery_ui' => array('deps' => array('jquery'), 'stylesheets' => array("$indicia_theme_path$indicia_theme/juery-ui.custom.css"), 'javascript' => array(self::$js_path."jquery-ui.custom.min.js", self::$js_path."jquery-ui.effects.js")),
   
        'jquery_form'deps' => array(''), 'stylesheets' => array(self::$css_path."default_site.c"jquery.form.js")),    'jquery_ui_fr' => array('deps' => array('jquery_ui'), 'javascript' => aray(self::reportPicker' => array('deps' => array('treeview'), 'javascript' => array(self::$js_path."reportPickert' => a
        'treevieway('indiciaMapEdit'), 'javascript' => array(self::$js_path."jquery.indiciaMap.edit.lotreeview.css"), 'javascript' => array(self::$js_path."jquery.treeview.js")),
        'treeview_async' => array('deps' => array('treeview'), 'javascript' => array(self::$js_path."jquery.treeview.async.js",eview.css"), 'javascript' => array(self::$jspath."jquery.treeview.js", self::$js_path."jquery.treeview.async.js",
          /api/js?sensor=false"=> rray('java'multimap' => array('javascript' => array("http://developer.multimap.com/API/maps/1.2/".parent::$multimap_api_ey)),
   pi?key=".parent::$google_search_api_key,
              self::$js_path."google_search.js"
            )
        ),
        'fancybox' => array('deps' => array('jquery'), 'stylesheets' => aray(self::,
       ...
       'treeBrowser' => array('deps' => array('jquery','jquery_ui'), 'javascript' => array(self::$js_path."jquery.treebrowser.js")),
        'defaulttylesheet' => array('deps' => array(''), 'stylesheets' => array(self::$css_path."default_site.css"), 'jmetadata.js', self::$js_path.'jquery.validate.js', self::$js_path.'additional-methodst' => aray()),
        'validation' => array('deps' => array('jquery'), 'javascript' => array(self
            self::$js_path.'jquery.uploader.js', self::$js_path.'plupload/js/plupload.full.min.js')),'javascript' => array(
            self::$js_path.'jquery.uploader.js', self::$js_path.'/plupload/js/plupload.full.min.js')),
    
                self::$js_path.'jqplot/jquery.jqplot.js',
                '[IE]'.self::$js_path.'jqplot/excanvas.js')),              self::$js_path.'jqplot/jquery.jqplot.min.js',
                '[IE]'.self::$js_path.'jqplot/excanv
        'jqplot_pierray('javascript' => array(self::$js_path.'jqplot/plugins/jqplot.pieRenpieRenderer.min.js')),r.min.js')),
        'jqplot_pie' => array('javascript' => array(self::$js_path.'jqplot/plugins/jqplot.pieRenderer.min.js')),
        'jqplt_category_axis_rcanvas_axis_label_renderer' => array('javascript' => array(self::$js_path.'jqplot/plugins/jqplot.canvasTextRenderer.min.js', self::$js_path.'jqplot/plugins/jqplot.canvasAxisLabel')),
        'jqplt_category_axis_renderer' => array('javascript' => array(self::$js_path.'jqplot/plugins/jqplot.categoryAxisRenderermin.js')),
        'jqplot_trendline' => array('javascript'=>array(self::$js_path.'jqplot/plugins/jqplot.trendline.min.js')),
        'reportgrid' = array('dereportfilters' => array('deps' => array('reportgrid'), 'stylesheets' => array(self::$css_path."report-filters.css"), 'javascript' => array(self::$js_path.'reportFiltersgrid' = array('deps' => array('jquery_ui'), 'javascript' => array(self::$js_path.'jquery.reportgrid.js', self::js_path.'json2.js')),
        'tabs' => array('deps' => array('jquery_ui'), 'javascript' => array(self::$js_path.'tabs.js'
        'spatialReports' => array('javascript'=>array(self::$js_path.'spatialReports.js')),css_path."wizard_progress.css"))deps' => array('jquery'), ),
        'spatialReports' => array('javascript'=>array(self::$js_path.'spatialReports.js')),
       'jsonwidget' => array('javascript'=>array(self::$js_path."jsonwidget/json.js", self::$js_path."jsonwi,
        'timeentry' => array('javascript'=>array(self::$js_path."jquery.timeentry.pack.js")),
        'verification' => array('javascript'=>array(self::$js_path."verification.jonwi,
        'control_speciesmap_controls' => array('deps' =>array('jquery', 'openlayers', 'addrowtogrid', 'validation'), 'javascript' => array(self::$js_path."controls/speciesmap_controls.jonwi,
  ...
  /**js"), 'stylesheets'=>array(self::$css_path."jsonwidget.css"))
      );
    }

   * control with the supplied ID.
   */**
   * Returns a span containing any validation errors active on the form fo
  ...
  {
    $error='';
    if (self::$validation_errors!==null) {ic static function check_errors($fieldname, $plaintext=false)
  {
 
         $errorKey = $fieldname;
       } elseif (substr($fieldname, -4)=='date') {
          // For date fields, we also include the type, start and end validation problems (substr($fieldname, -4)=='date') {
          // For date fields, we also includ
            $errorKey = $fieldname.'_start';
          }(array_key_exists($fieldname.'_start', self::$validation_errors)) {
       ...
       if (isset($errorKey)) {
         $error = self::$validation_errors[$errorKey];ldname.'_type';
          }
       }
       if (isset($errorKey)) {
         $error 
  ...
  public static function http_post($url, $postargs=null, $output_errors=true) {
    ...
    if ($postargs!==null) {
      curl_setopt ($session, CURLOPT_POST, true);    curif (is_array($postargs) && version_compare(phpversion(), '5.5.0') >= 0) {
    ...
    if ($curlErrno || $httpCode != 200) {
      if ($output_errors) {trpos($response, 'HTTP/1.1 200 OK')===false && strpos($response, 'Connection: close')===false)) {
      if ($output_errors) {
        echo '<div URL:'.$url.'<div cl
        if ($curlErrno) {
  ...
  /**array('result'=>true,'output'=>array_pop($arr_response));
    }
    curl_close($session);
   */
  public static function get_uploaded_image_folder() {
    if (!isset(self::$final_image_folder) || self::$final_image_folder=='warehouse') {
      ...
      self::getRootFolder() . self::client_helper_path() . .(isset(self::$indicia_upl
    }
  }
  ...
  public static function relative_client_helper_path() {
    ...
    $clientHelperFolder = explode(DIRECTORY_SEPARATOR, dirname(realpath(__FILE__)));nd php file folder as an array of tokens
    $clientHelperFolder = explode(DIRECTORY_SEPARATOR, dirname(r
   ...
   * <li><b>paramsToExclude</b><br/>aults</b><br/>
   * Associative array of default values for each form element.
   * </li>
   ...
   * </li>
   * <li><b>extraParams</b><br/>that should be skipped in the form output despite being in the form definition.
   * </li>
   * <li><b>presetParams</b>
   * </li>
   ...
   * </li>
   * </ul>y of  @param boolean $hasVisibleContent On completion, this is set to true if there are visible
   ...
   */ram names and values that have a fixed value and are, &$hasVisibleContent) {
    ...
    /ul>
   */
  p=(isset($options['fieldNamePrefix']) ? $options['fieldNamePrefixrefix = (isse
    ...
    foreach($options['form'] as $key=>$info) {
      ...
      if (count($tools)) {
        ...
        $fieldname=(isset($options['fieldNamePrefix']) ? $options['fieldNamePrefixrefix = (iss .$key;
      ...
      $r .= '<label>'.$ct
        ...
        'fieldname'=>'geom_buffer',
          'default'=>isset($_POST['geom_buffer']) ? $_POST['geom_buffer']
          // are available
          $r .= '<input type="hidden" name="orig-wkt" id="orig-wkt" '.
              'value="'.(isset($_POST['orig-wkt']) ? $_POST['orig-wkt'] : '')."\" />\n";
        }
        // Output some JavaScript to setup a toolbar for the map drawing tools. Also JST['orig  // to handle getting the polygons from the edit layer into the report parameter
...
abel' => $info['display'],
    ...
    if ($info['datatype']=='idlist') {
      ...
      $r .= "<input type=\"hidden\" name=\"$fieldPrefix$key\" value=\"".self::get_preset_param($options, $key)."\" />\n";s['pr} elseif ($info['datatype']=='lookup' && isset($info['population_call'])) {
options['presetParams'][$key]."\" />\n";
      } elseif ($info['datatype']=='lookup' && isset($info['populat:params(key=value,key=value,...)
      ...
      if (isset($info['linked_to']) && isset($info['linked_filter_field'])) {
        ...
        if (isset($options['extraParams']) && array_key_exists($info['linked_to'], $options['extraParams'])) {ield'])) {         if (isset($options['presetParams']) && array_key_exists($info['linked_to'], $options['presetParams'])) {

          // population call for this control
          $ctrlOptions = array_merge($ctrlOptions, array(ookup);
  the
            // population call for this control
            'query'=>json_encode(
  ...
  /**pts.standardControls.push('clearEditLayer');
}
mapSettingsHooks.push(add_map_tools)\n";
  ...
  /**
   * Takes an associative array and converts it to a list of params for a query string. This is likeoc
    );
  }

  /**
   * Takes an associative array and converts it to a list of params for a query string. This 
   ...
   */
   ublicuild_query but it does not url encode the & separator, and gives cont
    $params = array();
    if(is_array($array)) {
      arsort($array);
   ...
   *rray. This is used tparams Array holding the parameters to merge into the templatel
   * @param string $template Name of the template to use, or actual template text if
   * $useTemplateAsIs is set to true.
   * @param boolean $useTemplateAsIs If true then the template parameter contains the actual$useTemplateAsIs is set to true.
   * @param boolean $useTemplateAsIs If true then the template parameter ontains the actual
   * template text, otherwise it is the name of a template in the $indicia_templates array. Default 
   * otherwise they are escaped.tml If param boolean $allowEscapeQuotes If true then parameter names can be suffixes -esape-quote, -escape-dblquote, 
   ...
   */meter values inserted into the template,
   * otherwise they are escaped.
   * @return string HTML for the i, $allowEscapeQuotes the item
    global $indicia_templates;s looked up from the $options array.
   */
  protected static function apply_re
    $replaceTags=array();
    $replaceValues=array();
  ...
  /**Is) $template = $indicia_templates[$template];
    return str_replace($replaceTags, $replaceValues, $template);
  }
   ...
   * client_helpers/upload folder. $path Path to the file to upload, relative to the interim image path folder (normally the
   * client_helpers/upload fold
   * are being uploaded.ersist_auth Allows the write nonce to be preserved after sending the file, useful when several files
   * are beng uploaded.
   * @param array readAuth Read authorisation tokens, if not supplied then the $_POST array should contain
   * @return string Error message, or true if successful.
   */efault is data/handle_media, but could be import/upload_csv.
   * @return string Error message, or true if successful.
   */
    ...
    if (!file_exists($interim_path.$path))der : 'upload/';
    $interim_path = dirname(__FILE__).'/'.$interim_image_folder;
    if (!file_ex
    $serviceUrl = parent::$base_url."index.php/services/".$service;does not exist and cannot be uploaded to the Warehouse.";
    ...
    if ($persist_auth)
      $postargs['persist_auth'] = 'true';$readAuth))
      $postargs['nonce'] = $readAuth['nonce'];
    if ($persist_au
  ...
  */
  public static function get_auth($website_id, $password) {
    $postargs = "website_id=$website_id";for the website.
  */
  public static function get_auth($website_id, $password) {
    $postargs = "w
    $nonce = $response['output'];se = self::http_post(parent::$base_url.'index.php/services/security/get_nonce', $postargs
  ...
  */
  public static function get_read_auth($website_id, $password) {
    self::$website_id = $website_id; /* Store this for use with data caching */ction// Keep a non-random cache for 10 minutes. It MUST be shorter than the normal cache lifetime so this expires more frequently.
...
/**
  ...
  * 'read_t => the read authorisation array,
  * 'write' => the write authorisation input controls to insert into
  */
  public static function get_read_write_auth($website_id, $password) {
    ...
    $postargs = "website_id=$website_id"; {
    self::$website_id = $website_id; /* Store this for use with data caching */
    $postargs = "website_id=$w
    $nonces = json_decode($response['output'], true);se_url.'index.php/services/security/get_read_write_nonces', $postargs);
    $nonces = j
  ...
  /**    'auth_token' => sha1($nonces['write'].':'.$password),
        'nonce' => $nonces['write']
   * HTML file rather than using dump_javascript which must be called after the form is built.nd placed in the <head> of the
   * HTML file rather than using dump_javascript which mu
   * depending on what is on your form. dump_header is not intelligent because the form is notntly builds the required links
   * depending on what is on your form. dump_header is not int
   * @param $resources List of resources to include in the header. The available options are describedhich validates better.
   * @param $resources List of resources to include in the header. The available options
   *
  ...
  public static function dump_header($resources=null) {
    ...
    // place a css class on the body if JavaScript enabled. And output the resources   self::add_resource($resource)resources(self::$required_resources) . 
        self::get_scripts('$("body").addClass("js");', '', '', true);
  }

  /**rces
    return self::internal_dump_javascript('$("body").addClass("js");', '', '', self::$required_resources
  * page which uses the data entry helper so output all JavaScript required by previous calls.call @param boolean $closure Set to true to close the JS with a function to ensure $ will refer to jQuery.
  ...
  */
  public static function dump_javascript($closure=false) {
    // Add the default stylesheet to the end of the list, so it has highest CSS priority static function dump_javascript() {
    // Add the default stylesheet o the end of the list, so it has highest CSS priority
    if (self::$default_styles) self::add_resource('defaultStylesh
   ...
   */
  public static function get_scripts($javascript, $late_javascript, $onload_javascript, $includeWrapper=false, $closure=false) {s being dumped, so we don't do it again.
          array_push(self::$dumped_resources, $
...
";
  ...
  **
   * If required, setup jQuery validation. This JavaScript must be added at the end of form preparation otherwise we ould
  ...
  public static function setup_jquery_validation_js() {
    // In the following block, we set the validation plugin's error class to our template.ion setup_jquery_validation_js() {
    // In the following block, we set the valida
   ...
   * suffix template.
   *
   * @param string $template Name of the control template, from the global $indicia_templates variable.uffix template.
   *
   * @param string $template Name of the control template, from the global $indcia_templates variable.
   * @param array $options Options array containing the control replacement values 
   */
  public static function apply_template($template, $options) {
    ...
    }(array_key_exists('fieldname', $options)) {
        $error = self::check_err, or a hint option
    ...
    }ptions['outerClass'] .= ' ui-state-error';
      } else {
        $options['outerClass'] = 'u
    if (array_key_exists('fieldname', $options)) {
...
tic_template('requiredsuffix', $options);
    } else {
      $r .= self::apply_static_templa
    $r = self::get_help_text($options, 'before');
    //Add prefix
    $r .= self::apply_static_template('prefix', $options);
 $r = self::get_help_text($options, 'before');
    //Add prefix
    $r .= self::apply_static_template
    ...
    if (!empty($options['label'])) {
      $r .= str_replace(
          ...
          array(
              ...
              $options['label'],
              array_key_exists('inputId', $options) ? $options['in
          ),ons['id'],isset($options['labelTemplate']) ? $indicia_templates[$options['labelTemplate']] :
              array_key_ex
      );
    }
...
s['fieldname']);
    ...
    // Add a message to the control if there is an error and this option is set$indicia_templates['validation_icon'];
    }
    // Add a message to
...
tic_template('requiredsuffix', $options);
  ...
  * to contain a 'validation' entry. This must be set to an array of validation rules in Indicia the control's options array
  * to contain a 'validation' entry. This must be 
 ...
 /**on enable_validation($form_id) {
    self::$validated_form_id = $form_id;
    self::add_resource('validati
   * to trigger the jQuery validation plugin. rules in an options array into a string that can be used as the control class,
   * to trigger the jQuery v
  ...
  protected static function build_validation_class($options) {
    ...
    if (array_key_exists($options['fieldname'], self::$default_validation_rules)) {is_array($rules)) $rules = array($rules);
    if (array_key_exists($options['fieldname'], s
    }fault_validation_rules)) {
      $rules = array_merge($rules, self::$default_validation_rules[$options['fieldname']]);
    }

    foreach ($rules as $rule) {idation messages for jQuery to use, if the fields have internationalisation strings specifed
    foreach ($rules as $rule) {
      if (isset($custom_terms) && array_key_exists($options['fieldnam
  ...
  /**
    ...
    // Convert these rules into jQuery format.
    return self::convert_to_jquery_val_metadata($rule
   * the $options array contains a helpText entry.or a control, but only if the position matches the $helpTextPos value, and
  ...
  protected static function get_help_text($options, $pos) {
    $options = array_merge(array('helpTextClass'=>'helpText'), $options);ted static function get_help_text($options, $pos) {
    $options = array_merge(array('helpTextClass'=>'helpText
      $options['helpText'] = lang::get($options['helpText']);), $options);
    if (array_key_exists('helpText', $options) && !empty($options['helpText']) && self::$helpTextP
    } else
      return '';
  }

  /**pText}', $options['helpText'], self::apply_static_template('helpText', $options));
    } else
      return '';
  }
   ...
   */
  protected static function apply_replacements_to_template($template, $options) {s looked up from the $options array.
   */
  protected static function apply_re
    $replaceTags=array();
    $replaceValues=array();
    foreach (array_keys($options) as $option) {lace in the template.
    $replaceTags=array();
    $replaceValues=array(
  ...
  */f validation rules.
  * @todo Suspect there is a versioning issue, $optione, b
    $converted = array();
    foreach ($rules as $rule) {
      ...
      // the next test uses a regexp named expression to find the digit in a maximum rule (maximum[10])nverted[] = 'digits';
      // the next test u-?ses a regexp named expression
  ...
  * @param string $name The static template type. e.g. prefix or suffix.efault template or one
  * specified in the options
  * @param string $name 
  ...
  protected static function apply_static_template($name, $options) {
    ...
    if (array_key_exists($key, $options)) {
      ...
      if (array_key_exists($options[$key], $indicia_templates))
        ...
        $r = $indicia_templates[$name] .cified template exists
        $r = $indicia_templates[$options[$key]];
      else
  ...
  */
  ...
  private static function apply_error_template($error, $fieldname) {
    if (empty($error))
      return '';
    global $indicia_templates;
    if (empty($error)) return '';or, $fieldname) {
    if (empty($error))
      return '';
    global $indicia_templates;
    if (empty($error)) r
